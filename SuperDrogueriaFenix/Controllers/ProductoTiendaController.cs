...
namespace SuperDrogueriaFenix.Controllers
{
    public class ProductoTiendaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdProductoTienda,PrecioUnidadCompra,PrecioUnidadVenta,Stock,Activo,FechaRegistro")] ProductoTienda productoTienda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProductoTienda,PrecioUnidadCompra,PrecioUnidadVenta,Stock,Activo,FechaRegistro")] ProductoTienda productoTienda)
        {
