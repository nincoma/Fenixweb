...
namespace SuperDrogueriaFenix.Controllers
{
    public class ProductoTiendaController : Controller
    {
        ...
        {
            return View(await _context.ProductoTienda.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var productoTienda = await _context.ProductoTienda
        ...
        public async Task<IActionResult> Create([Bind("IdProductoTienda,PrecioUnidadCompra,PrecioUnidadVenta,Stock,Activo,Iniciado,FechaRegistro")] ProductoTienda productoTienda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProductoTienda,PrecioUnidadCompra,PrecioUnidadVenta,Stock,Activo,Iniciado,FechaRegistro")] ProductoTienda productoTienda)
        {
        ...
        {
            return _context.ProductoTienda.Any(e => e.IdProductoTienda == id);
        }
    }
}
